...
@section('contenido')
    ...
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        <h1 class="h3 mb-0 text-gray-800">Modal #2</h1>
    </div>
        ...
        <div class="card-body login-card-body">
            ...
            <form action="{{ route('saveFile') }}" method="post" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control form-control-user" name="link-80" value="{{ $data[79]['datos'] }}">
                </div>
                <div class="form-group">
                    <label for="texto">Título #2</label>
                    <input type="text" class="form-control form-control-user" name="link-81" value="{{ $data[80]['datos'] }}">
                </div>
                <div class="form-group">
                    <label for="texto">Texto #1</label>
                    <textarea id="basic-example" name="link-82">
                    {{ $data[81]['datos'] }}
                    </textarea>
                </div>
                <div class="form-group">
                    <label for="file">Imagen #1</label>
                    <input type="file" class="form-control" name="archivo-83">
                </div>
